...
const Footer = () => {
  return (
<footer
  class=" mt-8 flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
  ...
  <div class="w-full bg-black/5 p-4 text-center">
    © 2023 Copyright:
    <a href="https://tw-elements.com/">Co-Developer Team</a>
  </div>
</footer>
  )
}
